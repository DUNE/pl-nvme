...
# Output pins
set_output_delay -clock [get_clocks nvme0_clk] -min 0.0 [get_ports -filter NAME=~nvme0_reset]
set_output_delay -clock [get_clocks nvme0_clk] -max 1000.0 [get_ports -filter NAME=~nvme0_reset]
set_false_path -to [get_ports -filter NAME=~nvme0_reset]
#set_output_delay -clock [get_clocks nvme1_clk] -min 0.0 [get_ports -filter NAME=~nvme1_reset_n]
#set_output_delay -clock [get_clocks nvme1_clk] -max 1000.0 [get_ports -filter NAME=~nvme1_reset_n]
#set_false_path -to [get_ports -filter NAME=~nvme1_reset_n]

set_output_delay -clock [get_clocks nvme0_clk] -min 0.0 [get_ports -filter NAME=~leds*]
set_output_delay -clock [get_clocks nvme0_clk] -max 1000.0 [get_ports -filter NAME=~leds*]
...
set_property PACKAGE_PIN AL35 [get_ports nvme0_reset]
set_property IOSTANDARD LVCMOS18 [get_ports nvme0_reset]
#set_property PACKAGE_PIN AL35 [get_ports nvme1_reset_n]
#set_property IOSTANDARD LVCMOS18 [get_ports nvme1_reset_n]
set_property PACKAGE_PIN AK38 [get_ports {nvme0_clk_p}]
set_property PACKAGE_PIN AK39 [get_ports {nvme0_clk_n}]
set_property PACKAGE_PIN V38 [get_ports {nvme1_clk_p}]
set_property PACKAGE_PIN V39 [get_ports {nvme1_clk_n}]
