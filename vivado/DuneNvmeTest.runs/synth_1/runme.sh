...
HD_PWD='/usersc/ag17009/NVMe/BlockFormatting/Test/pl-nvme/vivado/DuneNvmeTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DuneNvmeTestTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DuneNvmeTestTop.tcl
