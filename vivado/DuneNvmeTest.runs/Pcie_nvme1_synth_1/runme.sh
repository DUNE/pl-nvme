...
HD_PWD='/usersc/ag17009/NVMe/BlockFormatting/Test/pl-nvme/vivado/DuneNvmeTest.runs/Pcie_nvme1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pcie_nvme1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pcie_nvme1.tcl
