...
HD_PWD='/usersc/ag17009/NVMe/BlockFormatting/Test/pl-nvme/vivado/DuneNvmeTest.runs/axis_data_fifo_ic_512_x_256_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_data_fifo_ic_512_x_256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_data_fifo_ic_512_x_256.tcl
